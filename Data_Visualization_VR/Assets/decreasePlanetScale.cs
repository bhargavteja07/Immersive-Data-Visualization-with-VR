...
public class decreasePlanetScale : MonoBehaviour
{
        ...
        for (i = 0; i < sl.Systems.Count; i++)
        {
            ...
            for (j = 0; j < sidePCount; j++)
            {
                ...
                if (sidePlanet != null)
                {
                    ...
                    sidePlanet.transform.localScale = new Vector3(sidePSize * rescaledPlanetScale / 1.07F, sidePSize * rescaledPlanetScale / 1.07F, 5.0F * 0.1F * rescaledPlanetScale / 1.07F);
                }
            }
            sideStarNum++;
        }
